...
class HashTable(object):
    ...
    def contains(self, key):
        ...
        # O(l) in worst case b/c iterates over all nodes if near tail or not found
        #bucket_node = bucket.find(lambda key_value: key_value[0] == key)
        #bucket.delete(bucket_node)
